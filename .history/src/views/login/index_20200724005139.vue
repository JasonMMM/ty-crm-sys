<template>
  <div class="login-container">
    <img class="login-bg-img" src="@/assets/images/login/morning.png" alt="">
    <el-row class="login-container-row">
      <!-- <el-col :sm="8" :xs="{span: 20, offset: 2}" class="login-left-col" style="z-index: 999
      ">
        <el-form
          ref="loginForm"
          :model="loginForm"
...
.login-container {
  ...
  .login-bg-img {
    ...
    width: 100%;
    height: 100%;
    filter: blur(20px);	-webkit-filter: blur(20px);  /* chrome, opera */
